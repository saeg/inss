...
/**
 * Builds a GXL Subsumption graph
 * 
 * @author Felipe Albuquerque
 */
public class GXLSubsumptionDuaBuilder {
	 ...
	 *            the graph ID
	 */
	public GXLSubsumptionDuaBuilder(String id) {
	...
	/**
	 * Creates an edge connecting a node to a p-use dua of the subsumption graph
	 * 
	 * @param id
	 *            the edge ID
	 * @param to
	 *            the subsumption node id
	 * @param from
	 *            p-use dua id
	 */
	public void createEdgeP(String id, String to, String from) {
		GXLEdge edge = new GXLEdge(from, to);

		edge.setAttribute("id", id);
		edge.insert(this.createGXLType(GXLSubmissionElement.EDGEP), 0);

		graph.insert(edge, graph.getChildCount());
	}

	/**
	 * Creates an edge connecting a node to a c-use dua of the subsumption graph
	 * 
	 * @param id
	 *            the edgep ID
	 * @param to
	 ...
	 *            c-use dua id
	 */
	public void createEdgeC(String id, String to, String from) {
		GXLEdge edge = new GXLEdge(from, to);

		edge.setAttribute("id", id);
		edge.insert(this.createGXLType(GXLSubmissionElement.EDGEC), 0);
	 ...
	 */
	public void createPUsoDua(String id, int defNode, int orig, int dest, int var) {
		GXLNode node = null;
	 ...
	 *            number of the variable
	 */
	public void createCUsoDua(String id, int defNode, int useNode, int var) {
		GXLNode node = null;
	...
	/**
	 * Defines a GXLType for the GXLSbumissionElement given
	 * 
	 * @param element
	 *            the element
